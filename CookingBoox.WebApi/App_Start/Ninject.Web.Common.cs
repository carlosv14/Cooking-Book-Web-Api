[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(CookingBoox.WebApi.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(CookingBoox.WebApi.App_Start.NinjectWebCommon), "Stop")]

namespace CookingBoox.WebApi.App_Start
{
    using System;
    ...
    using CookingBoox.WebApi.Utils.Security;
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<CookingBookContext>().ToSelf().InRequestScope();
        ...
        private class AuthorizationModule : NinjectModule
        {
            ...
            {
                this.Kernel.Bind<DbContext>().To<CookingBookContext>().InRequestScope();
        ...
        private class RepositoryModule : NinjectModule
        {
            public override void Load()
            {
                this.Kernel.Bind<IRepository<Recipe>>().To<RecipeRepository>();
            }
        }
    }
}